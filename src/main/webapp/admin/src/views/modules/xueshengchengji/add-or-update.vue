          ...
          <el-form-item class="input" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="学生学号" prop="xueshengxuehao">
          <el-select v-model="ruleForm.xueshengxuehao" placeholder="请选择学生学号">
            <el-option
          ...
          <el-form-item class="input" label="成绩" prop="chengji">
              <el-input v-model="ruleForm.chengji" 
                placeholder="成绩" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班排名" prop="banpaiming">
          <el-input v-model="ruleForm.banpaiming" 
              placeholder="班排名" clearable  :readonly="ro.banpaiming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班排名" prop="banpaiming">
              <el-input v-model="ruleForm.banpaiming" 
                placeholder="班排名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="级排名" prop="jipaiming">
          <el-input v-model="ruleForm.jipaiming" 
              placeholder="级排名" clearable  :readonly="ro.jipaiming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="级排名" prop="jipaiming">
              <el-input v-model="ruleForm.jipaiming" 
                placeholder="级排名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chengji = true;
            continue;
	            	            ...
	            	            if(o=='banpaiming'){
            this.ruleForm.banpaiming = obj[o];
	    this.ro.banpaiming = true;
            continue;
          }
	            	            if(o=='jipaiming'){
            this.ruleForm.jipaiming = obj[o];
	    this.ro.jipaiming = true;
            continue;
          }
	            	            if(o=='fabushijian'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                        ...
                                        this.kemuOptions = "英语,数学,语文,音乐,信息".split(',')
                                                                                                    },
                                                                // 多级联动参数
                                                                                  info(id) {
      this.$http({
