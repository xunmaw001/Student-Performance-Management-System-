              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiaoyuanfengcai" label="校园风采" prop="xiaoyuanfengcai">
                    <span v-html="ruleForm.xiaoyuanfengcai"></span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="校园简介" prop="xiaoyuanjianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiaoyuanjianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiaoyuanjianjie" label="校园简介" prop="xiaoyuanjianjie">
                    <span v-html="ruleForm.xiaoyuanjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaoyuanfengcai = true;
            continue;
	            	            ...
	            	            if(o=='xiaoyuanjianjie'){
            this.ruleForm.xiaoyuanjianjie = obj[o];
	    this.ro.xiaoyuanjianjie = true;
            continue;
          }
	                    }
                                                                              }
