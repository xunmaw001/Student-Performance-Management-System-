          ...
          <el-form-item class="input" label="总成绩" prop="zongchengji">
              <el-input v-model="ruleForm.zongchengji" 
                placeholder="总成绩" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="平均分" prop="pingjunfen">
          <el-input v-model="ruleForm.pingjunfen" 
              placeholder="平均分" clearable  :readonly="ro.pingjunfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="平均分" prop="pingjunfen">
              <el-input v-model="ruleForm.pingjunfen" 
                placeholder="平均分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.dengjishijian" label="登记时间" prop="dengjishijian">
              <el-input v-model="ruleForm.dengjishijian" 
                placeholder="登记时间" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="成绩表" prop="chengjibiao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.chengjibiao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chengjibiao" label="成绩表" prop="chengjibiao">
                    <span v-html="ruleForm.chengjibiao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pingjunfen = true;
            continue;
	            	            ...
	            	            if(o=='chengjibiao'){
            this.ruleForm.chengjibiao = obj[o];
	    this.ro.chengjibiao = true;
            continue;
          }
	            	            if(o=='jiaoshigonghao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `banjichengji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.banjichengjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
