        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="荣誉" prop="rongyu">
          <el-input v-model="ruleForm.rongyu" 
              placeholder="荣誉" clearable  :readonly="ro.rongyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="荣誉" prop="rongyu">
              <el-input v-model="ruleForm.rongyu" 
                placeholder="荣誉" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `youxiujiaoshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.youxiujiaoshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
